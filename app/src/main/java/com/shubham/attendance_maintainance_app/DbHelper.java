...
public class DbHelper extends SQLiteOpenHelper {
    ...
    long addStatus(long sid,long cid, String date, String status)
    {
        ...
        // if table is inserted then will return status id  otherwise -1.
        // So you can write the try catch of if statement for that -1 case. To handle that exception
    ...
    {
        SQLiteDatabase database = this.getReadableDatabase();
        return database.query(STATUS_TABLE_NAME, new String[]{DATE_KEY}, C_ID+"="+cid, null,"substr("+DATE_KEY+",4,7)", null, null); //01.04.2021 --> 4, 7
    }
}
